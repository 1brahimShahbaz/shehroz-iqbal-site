...
export const NAV_ITEMS: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    href: "/courses",
    children: [
      { label: "AS Level", href: "/courses/as-level-accounting-course", chipColor: "#1E8FCE" },
      { label: "A2 Level", href: "/courses/a2-level-accounting-course", chipColor: "#12466E" },
      { label: "O Level & IGCSE", href: "/courses/o-level-accounting-course", chipColor: "#1C6BAA" },
    ],
  },
